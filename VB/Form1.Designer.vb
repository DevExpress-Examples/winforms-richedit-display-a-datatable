...
'			Me.btnDisplayProducts.Click += New System.EventHandler(Me.btnDisplayProducts_Click);
			' 
			' Form1
			' 
		...
		Private WithEvents btnDisplayProducts As DevExpress.XtraEditors.SimpleButton
	End Class
End Namespace
